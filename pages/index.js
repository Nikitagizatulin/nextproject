    ...
    return (
      <Styles>
        ...
        <Title level={2} className="home-page_subtitle">
          It's simple way to stored your tasks. You can edit your task, delete and set to completed
          status. For started to use the application, please log in or sign up.
        </Title>
      </Styles>
    );
  }
